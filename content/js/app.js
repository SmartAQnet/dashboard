...
/************************************ Marker ************************************/
//                     create Markers and colorfunctions
/********************************************************************************/
...
function setupsimulations(number){
	for (let i = 0; i <= number-1; i++){
		randomlocation[i] = [params.mapCenter[0]+scalingfactor*(Math.random()-0.5),params.mapCenter[1]+scalingfactor*(Math.random()-0.5)];
...
function simulate(id){
	...
	randomvalue[id] = randomvalue[id]*(Math.random()+Math.random())/2;
	...
	removeoldfeatures(1000); //store time in milliseconds
};
